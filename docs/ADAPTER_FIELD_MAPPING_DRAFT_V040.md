...
| source literal | Adapter name | text | `source` | text | Yes | Fill `efinance` | Candidate-only source value. |
...
| source literal | Adapter name | text | `source` | text | Yes | Fill `mootdx` | Candidate-only source value. |
